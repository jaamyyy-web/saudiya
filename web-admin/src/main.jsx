...
const stats = [
  { label: 'Students', value: 'Live', change: 'From Firestore', icon: Users },
  ...
  { label: 'Premium Users', value: 'Live', change: 'From subscriptions', icon: Crown },
];
...
function Dashboard({ user, setActive }) {
  return <section className="page-grid">
    <div className="hero-card wide"><div><p className="eyebrow">Premium PC Admin</p><h2>Manage app content, quiz generation, students, and subscriptions from one URL.</h2><p>Upload files, publish Learning Packs, queue generation jobs, review questions, manage students, and track subscriptions.</p><div className="hero-actions"><button className="primary-button" onClick={() => setActive('content')}>Open Upload Manager</button><button className="secondary-button" onClick={() => setActive('generation')}><Sparkles size={18} /> Review Queue</button></div></div><div className="hero-visual"><GraduationCap size={74} /></div></div>
    <div className="panel-card wide"><div className="panel-header"><div><p className="eyebrow">Test Mode</p><h3>Create Live Demo Pack</h3></div><span className="badge success">No Gemini needed</span></div><DemoPackButton /></div>
