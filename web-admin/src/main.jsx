...
const stats = [
  ...
  { label: 'Premium Users', value: 'Live', change: 'Subscriptions soon', icon: Crown },
];
...
function Dashboard({ user, setActive }) {
  return <section className="page-grid">
    <div className="hero-card wide"><div><p className="eyebrow">Premium PC Admin</p><h2>Manage app content, quiz generation, students, and subscriptions from one URL.</h2><p>Upload files, publish Learning Packs, queue generation jobs, review questions, and manage students.</p><div className="hero-actions"><button className="primary-button" onClick={() => setActive('content')}>Open Upload Manager</button><button className="secondary-button" onClick={() => setActive('generation')}><Sparkles size={18} /> Review Queue</button></div></div><div className="hero-visual"><GraduationCap size={74} /></div></div>
