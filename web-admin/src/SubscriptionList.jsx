...
export default function SubscriptionList() {
  ...
  if (loading) return <div className="upload-message uploading"><RefreshCw size={16} /> Loading subscriptions...</div>;
  if (error) return <div className="upload-message error">{error}</div>;
  if (items.length === 0) return <div className="empty-review-card"><Crown size={28} /><strong>No subscriptions found</strong><p>Premium and Family records should appear in Firestore collection subscriptions.</p></div>;
