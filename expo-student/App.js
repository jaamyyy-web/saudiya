      ...
      <SafeAreaView style={styles.safe}>
        ...
        <View style={styles.app}>
          ...
          <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
            ...
            {tab === 'packs' && <Packs packs={displayPacks} selectedSubject={selectedSubject} setSelectedSubject={setSelectedSubject} selectedPack={selectedPack} setSelectedPack={setSelectedPack} />}
...
function Packs({ packs, selectedSubject, setSelectedSubject, selectedPack, setSelectedPack }) {
...
function Analytics({ analytics, leaderboard, openPacks }) {
...
function Profile({ student, analytics }) {
